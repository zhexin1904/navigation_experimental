...
if("TRUE" STREQUAL "TRUE")
  set(assisted_teleop_SOURCE_PREFIX /home/jason/ROSlearning/navigation_experimental/src/assisted_teleop)
  set(assisted_teleop_DEVEL_PREFIX /home/jason/ROSlearning/navigation_experimental/devel)
  ...
  set(assisted_teleop_INSTALL_PREFIX /home/jason/ROSlearning/navigation_experimental/install)
...
if(NOT "/home/jason/ROSlearning/navigation_experimental/src/assisted_teleop/include;/usr/include/eigen3 " STREQUAL " ")
  set(assisted_teleop_INCLUDE_DIRS "")
  set(_include_dirs "/home/jason/ROSlearning/navigation_experimental/src/assisted_teleop/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'assisted_teleop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jason/ROSlearning/navigation_experimental/src/assisted_teleop/${idir}'.  ${_report}")
    endif()
    _list_append_unique(assisted_teleop_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "laser_scan_max_range_filter")
...
set(depends "tf2_ros;costmap_2d;roscpp;roslib;geometry_msgs;move_base_msgs;actionlib;message_filters;base_local_planner;angles;pluginlib;sensor_msgs;filters")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(assisted_teleop_EXPORTED_TARGETS ${${assisted_teleop_dep}_EXPORTED_TARGETS})
endforeach()
