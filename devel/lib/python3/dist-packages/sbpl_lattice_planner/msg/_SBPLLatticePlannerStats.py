...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.initial_epsilon, _x.final_epsilon, _x.plan_to_first_solution, _x.allocated_time, _x.actual_time, _x.time_to_first_solution, _x.solution_cost, _x.path_size, _x.final_number_of_expands, _x.number_of_expands_initial_solution, _x.start.header.seq, _x.start.header.stamp.secs, _x.start.header.stamp.nsecs,) = _get_struct_2dB5d2q3I().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2dB5d2q3I = None
def _get_struct_2dB5d2q3I():
    global _struct_2dB5d2q3I
    if _struct_2dB5d2q3I is None:
        _struct_2dB5d2q3I = struct.Struct("<2dB5d2q3I")
    return _struct_2dB5d2q3I
_struct_7d = None
def _get_struct_7d():
    global _struct_7d
